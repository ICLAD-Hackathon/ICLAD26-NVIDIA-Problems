#
# OpenSTA timing analysis script for OpenTitan ASCON post-synthesis timing reports
...
set DESIGN_NAME [env_or_default DESIGN_NAME ascon]
...
if {[file exists $sdc_file]} {
  ...
  # OpenTitan ASCON uses clk_i (125 MHz = 8000 ps period)
  # clk_edn_i may or may not be present
