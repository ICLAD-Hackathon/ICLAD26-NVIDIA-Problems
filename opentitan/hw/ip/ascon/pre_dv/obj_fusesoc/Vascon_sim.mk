...
VM_PREFIX = Vascon_sim
# Module prefix (from --prefix)
VM_MODPREFIX = Vascon_sim
...
VM_USER_CFLAGS = \
	...
	-std=c++17 -Wall -DVM_TRACE_FMT_FST -DTOPLEVEL_NAME=ascon_sim -g -O0 \
...
VM_USER_DIR = \
	src/lowrisc_dv_verilator_ascon_sim_0.1/cpp \
	src/lowrisc_dv_verilator_simutil_verilator_0/cpp \


### Default rules...
# Include list of all generated classes
include Vascon_sim_classes.mk
...
ascon_tb.o: src/lowrisc_dv_verilator_ascon_sim_0.1/cpp/ascon_tb.cc
...
### Link rules... (from --exe)
Vascon_sim: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a $(VM_HIER_LIBS)
