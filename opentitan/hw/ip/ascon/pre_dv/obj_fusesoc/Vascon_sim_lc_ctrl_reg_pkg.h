...
#ifndef VERILATED_VASCON_SIM_LC_CTRL_REG_PKG_H_
#define VERILATED_VASCON_SIM_LC_CTRL_REG_PKG_H_  // guard

#include "verilated.h"

class Vascon_sim__Syms;
VL_MODULE(Vascon_sim_lc_ctrl_reg_pkg) {
  public:
    ...
    // CONSTRUCTORS
    Vascon_sim_lc_ctrl_reg_pkg(const char* name);
    ~Vascon_sim_lc_ctrl_reg_pkg();
    VL_UNCOPYABLE(Vascon_sim_lc_ctrl_reg_pkg);
