...
#ifndef VERILATED_VAES_TB_EDN_REG_PKG_H_
#define VERILATED_VAES_TB_EDN_REG_PKG_H_  // guard

#include "verilated.h"

class Vaes_tb__Syms;
VL_MODULE(Vaes_tb_edn_reg_pkg) {
  public:
    ...
    // CONSTRUCTORS
    Vaes_tb_edn_reg_pkg(const char* name);
    ~Vaes_tb_edn_reg_pkg();
    VL_UNCOPYABLE(Vaes_tb_edn_reg_pkg);
