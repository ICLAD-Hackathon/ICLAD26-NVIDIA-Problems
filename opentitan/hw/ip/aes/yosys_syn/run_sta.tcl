#
# OpenSTA timing analysis script for OpenTitan AES post-synthesis timing reports
...
set DESIGN_NAME [env_or_default DESIGN_NAME aes]
...
if {[file exists $sdc_file]} {
  ...
  # OpenTitan AES has two clock domains:
