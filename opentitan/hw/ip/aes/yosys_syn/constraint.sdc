# SDC constraints for OpenTitan AES
# Based on opentitan/hw/ip/aes/syn/constraints.sdc
#
...
# In real design, this may be different
...
# False paths for resets (use catch to handle missing ports gracefully)
