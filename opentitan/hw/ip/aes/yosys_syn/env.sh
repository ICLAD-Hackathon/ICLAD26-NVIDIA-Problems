#!/bin/bash
#
# Environment setup for OpenTitan AES Yosys synthesis
#
# Usage:
#   source env.sh
#   yosys -c syn.tcl
...
# Top module name
export DESIGN_NAME=${DESIGN_NAME:-aes}

# Verilog filelist
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
export VERILOG_FILELIST=${VERILOG_FILELIST:-${SCRIPT_DIR}/aes_yosys.f}
...
echo "=============================================="
echo "OpenTitan AES Yosys Synthesis Environment"
echo "=============================================="
