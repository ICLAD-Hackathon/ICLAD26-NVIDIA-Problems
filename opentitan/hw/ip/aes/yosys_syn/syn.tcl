#!/usr/bin/env yosys
#
# Yosys synthesis script for OpenTitan AES with ASAP7 PDK
...
#   DESIGN_NAME           - Top module name (default: aes)
...
#   constraint.sdc     - SDC constraints for OpenTitan AES
...
set DESIGN_NAME [env_var_or_default DESIGN_NAME aes]
...
# Parse filelist
set VERILOG_FILELIST [env_var_or_default VERILOG_FILELIST [file join $script_dir aes_yosys.f]]
