...
#ifndef VERILATED_VKMAC_REDUCED_TB_EDN_REG_PKG_H_
#define VERILATED_VKMAC_REDUCED_TB_EDN_REG_PKG_H_  // guard

#include "verilated.h"

class Vkmac_reduced_tb__Syms;
VL_MODULE(Vkmac_reduced_tb_edn_reg_pkg) {
  public:
    ...
    // CONSTRUCTORS
    Vkmac_reduced_tb_edn_reg_pkg(const char* name);
    ~Vkmac_reduced_tb_edn_reg_pkg();
    VL_UNCOPYABLE(Vkmac_reduced_tb_edn_reg_pkg);
