#!/usr/bin/env yosys
#
# Yosys synthesis script for OpenTitan KMAC with ASAP7 PDK
...
#   DESIGN_NAME           - Top module name (default: kmac)
...
#   constraint.sdc     - SDC constraints for OpenTitan KMAC
...
set DESIGN_NAME [env_var_or_default DESIGN_NAME kmac]
...
# Parse filelist
set VERILOG_FILELIST [env_var_or_default VERILOG_FILELIST [file join $script_dir kmac_yosys.f]]
