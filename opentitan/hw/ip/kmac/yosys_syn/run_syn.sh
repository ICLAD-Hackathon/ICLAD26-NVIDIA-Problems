#!/bin/bash
#
# Run synthesis and STA for OpenTitan KMAC
#
# Usage:
...
#   DESIGN_NAME=kmac|sha3|keccak_2share|keccak_round  # Module to synthesize
...
show_usage() {
    ...
    echo "  DESIGN_NAME=...       Module to synthesize (default: kmac)"
    echo "                        Options: kmac, sha3, keccak_2share, keccak_round"
    ...
    echo "  DESIGN_NAME=sha3 ./run_syn.sh   # Synthesize sha3 module"
