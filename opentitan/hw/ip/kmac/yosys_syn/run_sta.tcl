#
# OpenSTA timing analysis script for OpenTitan KMAC post-synthesis timing reports
...
set DESIGN_NAME [env_or_default DESIGN_NAME kmac]
...
if {[file exists $sdc_file]} {
  ...
  # OpenTitan KMAC has two clock domains:
  #   - clk_i:     Main clock (125 MHz = 8000 ps period)
  #   - clk_edn_i: EDN clock (125 MHz = 8000 ps period)
  create_clock -name clk_i -period 8000 [get_ports clk_i]
  create_clock -name clk_edn_i -period 8000 [get_ports clk_edn_i]
