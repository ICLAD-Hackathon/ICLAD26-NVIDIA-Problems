#!/bin/bash
#
# Run synthesis and STA for NVDLA (NV_nvdla)
#
# Usage:
...
CORNER=${CORNER:-TT}
ABC_AREA=${ABC_AREA:-0}
DESIGN_NAME=${DESIGN_NAME:-NV_nvdla}
DRY_RUN=${DRY_RUN:-0}
...
run_synthesis() {
    ...
    print_info "Note: NVDLA is a large design, synthesis may take significant time..."
...
run_sta() {
    ...
    print_info "Note: NVDLA is a large design, STA may take significant time..."
...
show_usage() {
    ...
    echo "  ABC_AREA=1 ./run_syn.sh syn     # Run area-optimized synthesis"
