...
#ifndef VERILATED_VNV_NVDLA_NV_NVDLA_PDP_RDMA_RO_FIFO_H_
#define VERILATED_VNV_NVDLA_NV_NVDLA_PDP_RDMA_RO_FIFO_H_  // guard

#include "verilated.h"

class VNV_nvdla__Syms;
VL_MODULE(VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo) {
  public:
    ...
    // CONSTRUCTORS
    VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo(const char* name);
    ~VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo();
    VL_UNCOPYABLE(VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo);
