...
VL_ATTR_COLD void VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo___ctor_var_reset(VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VNV_nvdla__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__ro_rd_pd_p = VL_RAND_RESET_Q(33);
    vlSelf->__Vcellinp__ram__ra = VL_RAND_RESET_I(3);
    vlSelf->__PVT__rd_adr_next_popping = VL_RAND_RESET_I(2);
    vlSelf->__PVT__ro_rd_prdy_d = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_prdy_d_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_pvld_int = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_pvld_int_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_count_p = VL_RAND_RESET_I(3);
    vlSelf->__PVT__rd_count_p_next = VL_RAND_RESET_I(3);
    vlSelf->__PVT__ro_rd_pd_o = VL_RAND_RESET_Q(33);
    vlSelf->__PVT__rd_req_next_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_pvld_int_d = VL_RAND_RESET_I(1);
    vlSelf->__PVT__rd_req_next = VL_RAND_RESET_I(1);
    vlSelf->__PVT__nvdla_core_clk_mgate__DOT__p_clkgate__DOT__qd = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ram__DOT__ram_ff0 = VL_RAND_RESET_Q(33);
    vlSelf->__PVT__ram__DOT__ram_ff1 = VL_RAND_RESET_Q(33);
    vlSelf->__PVT__ram__DOT__ram_ff2 = VL_RAND_RESET_Q(33);
    vlSelf->__PVT__ram__DOT__ram_ff3 = VL_RAND_RESET_Q(33);
    vlSelf->__Vdly__ro_rd_pvld_int = VL_RAND_RESET_I(1);
}
