...
VL_ATTR_COLD void VNV_nvdla_NV_NVDLA_CDP_RDMA_ro_fifo___ctor_var_reset(VNV_nvdla_NV_NVDLA_CDP_RDMA_ro_fifo* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VNV_nvdla__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                VNV_nvdla_NV_NVDLA_CDP_RDMA_ro_fifo___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__ro_wr_count = VL_RAND_RESET_I(4);
    ...
    vlSelf->__PVT__ro_wr_adr = VL_RAND_RESET_I(3);
    vlSelf->__PVT__rd_popping = VL_RAND_RESET_I(1);
    vlSelf->__PVT__ro_rd_adr = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__ro_rd_count_p = VL_RAND_RESET_I(4);
    ...
    vlSelf->__Vdly__ro_wr_adr = VL_RAND_RESET_I(3);
}
