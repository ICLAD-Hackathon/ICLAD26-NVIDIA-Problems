...
VNV_nvdla_NV_NVDLA_CDMA_dual_reg::VNV_nvdla_NV_NVDLA_CDMA_dual_reg(const char* _vcname__)
...
void VNV_nvdla_NV_NVDLA_CDMA_dual_reg::__Vconfigure(VNV_nvdla__Syms* _vlSymsp, bool first) {
