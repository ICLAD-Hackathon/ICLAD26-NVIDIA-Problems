...
#ifndef VERILATED_VNV_NVDLA_SCANSHARESEL_JTAG_REG_EXT_CG__PI7_H_
#define VERILATED_VNV_NVDLA_SCANSHARESEL_JTAG_REG_EXT_CG__PI7_H_  // guard

#include "verilated.h"

class VNV_nvdla__Syms;
VL_MODULE(VNV_nvdla_ScanShareSel_JTAG_reg_ext_cg__pi7) {
  public:
    ...
    // CONSTRUCTORS
    VNV_nvdla_ScanShareSel_JTAG_reg_ext_cg__pi7(const char* name);
    ~VNV_nvdla_ScanShareSel_JTAG_reg_ext_cg__pi7();
    VL_UNCOPYABLE(VNV_nvdla_ScanShareSel_JTAG_reg_ext_cg__pi7);
