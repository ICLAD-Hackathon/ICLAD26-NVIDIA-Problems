...
VL_ATTR_COLD void VNV_nvdla_NV_NVDLA_PDP_WDMA_DAT_fifo___ctor_var_reset(VNV_nvdla_NV_NVDLA_PDP_WDMA_DAT_fifo* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VNV_nvdla__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                VNV_nvdla_NV_NVDLA_PDP_WDMA_DAT_fifo___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__dat_fifo_wr_count = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__dat_fifo_wr_adr = VL_RAND_RESET_I(2);
    vlSelf->__PVT__rd_popping = VL_RAND_RESET_I(1);
    vlSelf->__PVT__dat_fifo_rd_adr = VL_RAND_RESET_I(2);
    ...
    vlSelf->__PVT__dat_fifo_rd_count_p = VL_RAND_RESET_I(3);
    ...
    vlSelf->__Vdly__dat_fifo_wr_adr = VL_RAND_RESET_I(2);
}
