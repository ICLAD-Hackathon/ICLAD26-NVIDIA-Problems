...
set DESIGN_NAME [env_var_or_default DESIGN_NAME sha512]

# RTL directory (default: ../src/rtl relative to script for sha512)
set rtl_dir [env_var_or_default RTL_DIR [file join $script_dir .. src rtl]]
...
set ABC_AREA [env_var_or_default ABC_AREA 0]
...
if {[env_var_exists_and_non_empty VERILOG_FILES]} {
  ...
  # Default RTL files for sha512
  set VERILOG_FILES [list \
    [file join $rtl_dir sha512.v] \
    [file join $rtl_dir sha512_core.v] \
    [file join $rtl_dir sha512_w_mem.v] \
    [file join $rtl_dir sha512_k_constants.v] \
    [file join $rtl_dir sha512_h_constants.v] \
  ]
}
